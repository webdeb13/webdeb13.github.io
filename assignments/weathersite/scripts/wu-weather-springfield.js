//Springfield Weather API from weather underground

var weatherObject = new XMLHttpRequest();

weatherObject.open("GET", "http://api.wunderground.com/api/3fc4151c5f15ec4b/conditions/forecast/q/MN/Springfield.json", true);
